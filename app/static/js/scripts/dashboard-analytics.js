...
$(window).on('load', function() {
	...
	/*
	 * Browser stats & revenue by make card
	 */
	// Trending Radar
	...
	var polarChartmake = document.getElementById("polar-chart-make").getContext("2d");
	window.polarChartmake = new Chart(polarChartmake).PolarArea(polarData, {
